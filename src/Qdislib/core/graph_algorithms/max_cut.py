...
def solve_maxcut_expected_value(G, observables, p=1, num_shots=8000, cut=None, max_qubits=None,gate_cut=True,wire_cut=True,draw=False, seed=10, chunk=1,verbose=False,sync=True,gpu=False,gpu_counter=0):
    if cut is not None:
